...
void CubeMapFramebuffer::generate()
{
    ...
    cam_posx->createProjectionPerspective(deg2rad(90.0f), 1.0f, 0.01f, 10000.0f);
    cam_posy->createProjectionPerspective(deg2rad(90.0f), 1.0f, 0.01f, 10000.0f);
    cam_posz->createProjectionPerspective(deg2rad(90.0f), 1.0f, 0.01f, 10000.0f);

    cam_newx->createProjectionPerspective(deg2rad(90.0f), 1.0f, 0.01f, 10000.0f);
    cam_newy->createProjectionPerspective(deg2rad(90.0f), 1.0f, 0.01f, 10000.0f);
    cam_newz->createProjectionPerspective(deg2rad(90.0f), 1.0f, 0.01f, 10000.0f);
